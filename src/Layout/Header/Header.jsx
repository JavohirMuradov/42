...
import Changer from "../../i18n/Changer";
...
function Header() {
    ...
    return (
        <header className={`sticky top-0 w-full ${ThemeChanger(" bg-white", "bg-[#020817]")} z-50`} >
            <nav className={`block rounded-xl border border-white/80 text-white py-2 container lg:py-4 shadow-none border-none`}>
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <div className="flex items-center gap-x-1">
                        <Button className={`${ThemeChanger("bg-white text-black", "bg-transparent text-white")} shadow-none hover:shadow-none py-2 px-4`} variant="text">
                            <Changer />
                        </Button>
                                ...
                                <Menu placement="left-start">
                                    <MenuHandler>
                                        <div className="flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent text-black">
                                            ...
                                            <span>{t("header.sozlamalari")}</span>
