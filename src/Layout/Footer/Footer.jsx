        ...
        <footer className="bg-background border-t">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-12 lg:px-8">
                ...
                <div className="mt-10 flex justify-center space-x-10">
                    <a className={`${ThemeChanger("text-[#02081799] hover:text-primary", "text-white")}`} target="_blank" href="https://instagram.com/qirikki">
                    ...
                    <a className={`${ThemeChanger("text-[#02081799] hover:text-primary", "text-white")}`} target="_blank" href="https://github.com/42uz">
                        <span className="sr-only">
                            GitHub
                        </span>
                        <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6" aria-hidden="true">
                    ...
                    <a className={`${ThemeChanger("text-[#02081799] hover:text-primary", "text-white")}`} target="_blank" href="https://youtube.com/@qirikki">
                        <span className="sr-only">
                            YouTube
                        </span>
                        <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6" aria-hidden="true">
